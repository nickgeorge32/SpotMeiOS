...
class PageViewController: UIPageViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
    ...
    lazy var orderedViewControllers: [UIViewController] = {
        return [self.newVc(viewController: "Welcome1ViewController"),
                self.newVc(viewController: "Welcome2ViewController"),
                self.newVc(viewController: "Welcome3ViewController"),
                self.newVc(viewController: "Welcome4ViewController")]
    }()
